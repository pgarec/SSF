...
def evaluate_techniques(cfg):
    ...
    isotropic_loss = evaluate_isotropic(cfg, models, test_loader, criterion)
    fisher_loss = evaluate_fisher(cfg, models, test_loader, criterion)
    ...
    results = {'isotropic loss': isotropic_loss, 'fisher_loss': fisher_loss, 'output_loss': output_loss}
    print(results)
